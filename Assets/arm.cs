...
public class arm : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        X[4] = Target.transform.localPosition.x*100; // àáñöèññà öåëåâîé òî÷êè
        Y[4] = Target.transform.localPosition.y*100; // âûñîòà öåëåâîé òî÷êè îò 0 áàçû (åñëè íèæå, òî ìèíóñ)
